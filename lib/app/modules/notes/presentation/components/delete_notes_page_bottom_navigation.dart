...
class DeleteNotesPageBottomNavigation extends HookConsumerWidget {
  const DeleteNotesPageBottomNavigation({super.key});
  @override
  Widget build(BuildContext context, WidgetRef ref) {
    final deletedNotesCount = ref.watch(deletedNotesProvider).length;
